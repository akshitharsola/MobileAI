# MobileAI — Distributed Edge AI Inference Node

**Turn your Android phone into a portable local AI server**

> App source: [`MobileAI/`](MobileAI/) | Architecture plan: [`distributed_mobile_llm_architecture_plan.md`](distributed_mobile_llm_architecture_plan.md)
